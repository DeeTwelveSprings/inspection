...
@Component({
  selector: 'app-web-bookings',
  templateUrl: './web-bookings.component.html',
  styleUrls: ['./web-bookings.component.scss']
})
export class WebBookingsComponent implements OnInit {
  ...
  public getBookingList(){
    var url = this.globals.getWebsiteBookings;
